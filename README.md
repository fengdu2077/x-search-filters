...
> **避免重复安装**：如果你已从 Chrome 应用商店安装过本扩展，请不要再加载 GitHub 版，反之亦然。同时启用两份功能相同的扩展，可能导致「高级搜索」按钮在某些操作后点击无反应。只保留一份即可。
...
- 本扩展通过 GitHub 分发，可使用 Chrome 开发者模式以未打包扩展形式加载。
- 扩展依赖 X 页面中的搜索框 DOM。若 X 调整页面结构，可能导致按钮识别或部分交互失效。
- 如果你在使用中遇到问题，欢迎提交 issue；如果你愿意改进代码，也欢迎发起 PR。
